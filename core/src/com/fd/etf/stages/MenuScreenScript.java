        ...
        if (startTransitionIn) {
            ...
            if (curtain_mm.getComponent(TintComponent.class).color.a <= 0) {
                ...
                menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(ActionComponent.class).dataArray.add(Actions.sequence(
                        Actions.delay(1.5f), Actions.fadeIn(2f, Interpolation.exp5Out), Actions.delay(2f), Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation+2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y+10, 0.3f, Interpolation.fade)),
                        Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation-2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y, 0.3f, Interpolation.fade)),
                        Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation+2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y+10, 0.3f, Interpolation.fade)),
                        Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation-2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y, 0.3f, Interpolation.fade)),
                        Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation+2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y+10, 0.3f, Interpolation.fade)),
                        Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation-2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y, 0.3f, Interpolation.fade)),
                        Actions.parallel(Actions.rotateTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).rotation+2, 0.3f), Actions.moveTo(menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).x, menuItem.getChild(TAP_TO_PLAY).getEntity().getComponent(TransformComponent.class).y+10, 0.3f, Interpolation.fade)),
